...
(setq doom-font (font-spec :family "JetBrains Mono Nerd Font" :size 24)
      doom-big-font (font-spec :family "JetBrains Mono Nerd Font" :size 36)
...
#+begin_src emacs-lisp :tangle no
(defvar required-fonts '("JetBrainsMono.*" "Overpass Nerd Font" "JuliaMono" "BlexMono Nerd Font" "Merriweather" "Alegreya"))
