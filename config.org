...
CUSTOM:
Rebind the keybindings for changing the font size.
...
# #+begin_src emacs-lisp :tangle packages.el
# (package! sunshine :recipe (:host github :repo "aaronbieber/sunshine.el"))
# #+end_src
...
#   :config
#   (setq sunshine-location "01099,Germany"
#         sunshine-appid "f40504da73325d6dbfbfc26a303a68d2"))
# #+end_src
*** Spray
...
| 1.4.6 |
*** Sending
SmtpMail seems to be the 'default' starting point, but that's not packaged for
...
(setq sendmail-program "/usr/bin/msmtp"
      ...
      message-sendmail-extra-arguments '("-a" "default" "--read-envelope-from"); , "--read-recipients")
...
#+begin_src emacs-lisp :tangle yes
(setq jethro/default-bibliography `(,(expand-file-name "org/notes/biblio.bib" org-directory)))
#+end_src
...
**** CUSTOM: some changes from [[[[https://yannesposito.com/posts/0015-how-i-use-org-mode/index.html#workflow-3--org-capture---org-refile]]
...
:PROPERTIES:
:ID:       324a91d8-6fe0-4dba-971b-e8ec95be03c1
:END:
