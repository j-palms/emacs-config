...
# This stub for the shell setup script needs to appear before any
...
(if (= 0 (call-process "sh" nil nil nil "-c" "dmesg | grep -q 'Kyria'"))
    (pp '<<avy-colemak-setup>>)
  ";; Avy: Colemak layout not detected (Kyria not mentioned in dmesg).")
#+end_src
