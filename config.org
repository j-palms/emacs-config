...
(after! citar
  ...
  (setq citar-notes-paths org-roam-directory); List of directories for reference nodes
  (setq citar-at-point-function 'embark-act))           ; Use `embark'
#+end_src
