...
(setq doom-font (font-spec :family "JetBrainsMono Nerd Font" :size 24)
      ...
      doom-variable-pitch-font (font-spec :family "Source Sans 3" :size 28)
...
(plist-put org-format-latex-options :zoom 2) ; Calibrated based on the TeX font and org-buffer font.
#+end_src
